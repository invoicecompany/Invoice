...
class NeighborhoodsControllerTest < ActionController::TestCase
  ...
  test "should create neighborhood" do
    assert_difference('Neighborhood.count') do
      post :create, neighborhood: { barrio: @neighborhood.barrio, dealer_id: @neighborhood.dealer_id, fecha_entrega: @neighborhood.fecha_entrega }
    end
  ...
  test "should update neighborhood" do
    patch :update, id: @neighborhood, neighborhood: { barrio: @neighborhood.barrio, dealer_id: @neighborhood.dealer_id, fecha_entrega: @neighborhood.fecha_entrega }
    assert_redirected_to neighborhood_path(assigns(:neighborhood))
  end
